    ...
    python:
        ...
        # No holiday, so pick a greeting or random event
            ...
            if (
                ...
                # Detect the first force quit
                and jn_farewells.JNForceQuitStates(store.persistent.jn_player_force_quit_state) != jn_farewells.JNForceQuitStates.first_force_quit
                # Detect subsequent force quits
                and not Natsuki.getQuitApology()
                and not persistent._jn_player_admission_type_on_quit
